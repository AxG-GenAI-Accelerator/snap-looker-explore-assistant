...
/*
      ...
      */
      const exploreData = 'https://looker.example.com/explore/lookertestv8/stores?fields\u003dlookertestv8.ice_store_id,lookertestv8.city\u0026sorts\u003dlookertestv8.count%20desc\u0026limit\u003d5' /*await runSQLQuery[0]['generated_content']*/;
      const cleanExploreData = exploreData.replace(/```json/g, '').replace(/```/g, '').trim();
