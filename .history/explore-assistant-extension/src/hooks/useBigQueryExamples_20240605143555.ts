...
export const useBigQueryExamples = () => {
  ...
  const getExamplePrompts = async () => {
    ...
    return runExampleQuery(sql).then((response) => {
      ...
      console.log('useBQ setExploreGenerationExamples : ',setExploreGenerationExamples(generationExamples))

      console.log('useBQ setExploreGenerationExamples length: ',setExploreGenerationExamples(generationExamples).length)
    })
  }
