...
export const useBigQueryExamples = () => {
  ...
  const getExamplePrompts = async () => {
    ...
    return runExampleQuery(sql).then((response) => {
      ...
      console.log('setExploreGenerationExamples: ',setExploreGenerationExamples(generationExamples))
    })
  }
  ...
  `
    return runExampleQuery(sql).then((response) => {
      ...
      console.log('setExploreRefinementExamples: ',setExploreRefinementExamples(refinementExamples))
