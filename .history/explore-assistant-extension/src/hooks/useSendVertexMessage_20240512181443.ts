...
const useSendVertexMessage = () => {
  ...
  const vertextBigQuery = async (
    ...
    console.log('VERTEX BQ Model:', VERTEX_BIGQUERY_LOOKER_CONNECTION_NAME);
    console.log('Contents:', VERTEX_BIGQUERY_LOOKER_CONNECTION_NAME);
    console.log('Parameters:', VERTEX_BIGQUERY_LOOKER_CONNECTION_NAME);
