...
view: lookertestv8 {
  ...
  dimension: activation_count_per_store_5mi {
    ...
    tags: ["activation", "geography", "store"]
  }
  dimension: address {
    type: string
  ...
  dimension: daytime_population_per_store {
    ...
    tags: ["geography", "demographic", "store"]
  }
  dimension: dma {
    type: string
  ...
  dimension: gstore_sales_5mi {
    ...
    tags: ["google", "store", "sales", "geography"]
  }
  ...
  dimension: lulu_store_count_5mi {
    ...
    tags: ["geography", "store", "lululemon"]
  }
  ...
  dimension: pixel_search_per_store_5mi {
    ...
    tags: ["pixel", "search", "geography", "store"]
  }
...
dimension: rolling_all_partners_three_years_activations {
  ...
  tags: ["activation", "partner", "timeframe"]
}
...
dimension: smartphone_households_5mi {
  ...
  tags: ["geography", "demographic", "smartphone"]
}
dimension: smartphone_households_per_store_5mi {
  ...
  tags: ["geography", "demographic", "smartphone", "store"]
}
dimension: state {
  type: string
